...
$GLOBALS['TL_LANG']['MOD']['internetschach_importTable_headline'] = array('Tabelle aus einer HTML- oder JSON-Datei importieren', 'Tabelle aus einer HTML- oder JSON-Datei importieren');
$GLOBALS['TL_LANG']['MOD']['internetschach_importTable_file'] = array('Datei', 'Datei auswählen');
$GLOBALS['TL_LANG']['MOD']['internetschach_importTable_submit'] = array('Import starten', 'Import starten');
