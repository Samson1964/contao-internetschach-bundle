...
$GLOBALS['TL_LANG']['tl_internetschach']['importCSV'] = array('Spielerdaten-Import', 'Spielerdaten-Import');
$GLOBALS['TL_LANG']['tl_internetschach']['exportXLS'] = array('Excel-Export', 'Excel-Export');
